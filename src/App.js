...
class App extends Component {
  ...
  playAgain = () => {
    ...
    this.timerId = setInterval(this.timeStatus, 1000)
  ...
  render() {
    const {activeTabId, time, score, imgUrl, isActive} = this.state
    ...
    return (
      <div className="app-container">
        <nav className="nav-container">
          ...
          />
          <ul className="">
            <li className="nav-score-timer-container">
